...
def linex():
	print('━━━━━━━━━━━━━━━━━━━━━━━━')
def contact():
	os.system('xdg-open https://www.facebook.com/mueidmursalin.rifat ')
	back()
G = "\u001b[32m"
B = "\u001b[36m"
W = "\033[1;37m"
...
TELEGRAM  : TEAM CYBER DEMON
VERSION   : 3.0
PROJECT   : FILE DUMPING
FACEBOOK  : Mueid Mursalin Rifat
××××××××××××××××××××××××××××××××××××××××××××""")
		print('')
		em = str(input(f"PUT ID/EMAIL|[✅] :"))
		print('')
...
××××××××××××××××××××××××××××××××××××××××××××""")
		print('')
		print('[\u001b[36m1\033[1;37m] \033[1;33mLOGIN WITH ID PASS |')
		print('[\u001b[36m2\033[1;37m] \033[1;33mLOGIN WITH COOKIES |')
...
def main_menu():
	os.system("clear")
	os.system('espeak -a 300 " Tool Owner Mueid Mursalin Rifat"')
...
××××××××××××××××××××××××××××××××××××××××××××""")
		print('')
		limit = input(f" [{B}•{W}] HOW MANY UID YOU HAVE ")
		print('')
		try:
			print('')
			print(f' [{B}•{W}] WRITE FILE NAME  rifat.txt  ')
			print('')
